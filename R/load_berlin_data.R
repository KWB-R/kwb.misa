...
load_berlin_rivers <- function(){
  files <- dir(file.path(system.file(package = "kwb.misa"),
                               "extdata/berlin_data"), full.names = T)

  filenames <- dir(file.path(system.file(package = "kwb.misa"),
                               "extdata/berlin_data"), full.names = F)
